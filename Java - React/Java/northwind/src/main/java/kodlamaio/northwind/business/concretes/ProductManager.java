...
@Service		// Bu class servis görevi görecek projede diyoruz.
public class ProductManager implements ProductService{

	private ProductDao productDao;
	
	@Autowired		// projede bu interface'e karşılık gelecek sınıfı buluyor.
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithCategoryDetails() {
		...
		return new SuccessDataResult<List<ProductWithCategoryDto>> (this.productDao.getProductWithCategoryDetails(), "ilişkili veriler listelendi");
	}
