...
import com.example.kisileruygulamasi.viewModel.viewModelFactory.KisiKayitVMF;
...
public class KisiKayitFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new KisiKayitVMF(requireActivity().getApplication())).get(KisiKayitFragmentViewModel.class);
    }
