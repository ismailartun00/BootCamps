...
import com.example.kisileruygulamasi.viewModel.viewModelFactory.KisiDetayVMF;
...
public class KisiDetayFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new KisiDetayVMF(requireActivity().getApplication())).get(KisiDetayFragmentViewModel.class);
    }
